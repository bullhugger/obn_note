...
///////////////////////////////////////////////////////////////////////////
//Assign percentage color
$('.percentage-value').each(function() {
    const percentage_text = $(this).text();
    const percentage = parseFloat(percentage_text);
    let color = progressColor(percentage);
    $(this).addClass('badge badge-' + color.badge);
})
